...
const AdminBannerCreate = () => {
    ...
    const createDTO = Yup.object({
        ...
        status: Yup.object({
            label: Yup.string().matches(/^(Published|Unpublished)$/),
    ...
    const submitForm = async (data: any) => {
        try {
            ...
            toast.error("Error Creating Banner at the moment")
        }finally{
            setLoading(false)
        }
    }
        ...
        <section>
            <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8 ">
                <div className="grid grid-cols-1 gap-8  lg:gap-16">
                    <h1 className="text-4xl text-center font-bold">Create Banner</h1>
                </div>
                <div className="rounded-lg border border-gray-200 mt-16">
                    <div className="overflow-x-auto rounded-t-lg">
                        <form className="grid grid-cols-6 gap-6" onSubmit={handleSubmit(submitForm)}>
                            ...
                            <div className="col-span-6">
                                <label htmlFor="link" className=" block text-sm font-medium text-gray-700"> Link <span className="text-red-800">*</span></label>
                                <TextInputField control={control} type="url" name="link" errMsg={errors?.link?.message as string} />
                            ...
                            <div className="col-span-6">
                                ...
                                <SelectOptionComponent  
                                    options={[{ label: "Published", value: "active" }, { label: "Unpublished", value: "inactive" }]}
                                    name="status"
                                    control={control}
